...
#修改型号显示
sed -i 's/Xiaomi Redmi Router AC2100/RM AC2100/g' target/linux/ramips/dts/mt7621_xiaomi_redmi-router-ac2100.dts
sed -i 's/Xiaomi Mi Router AC2100/RM AC2100/g' target/linux/ramips/dts/mt7621_xiaomi_mi-router-ac2100.dts
#删除自带低版本xray-core
